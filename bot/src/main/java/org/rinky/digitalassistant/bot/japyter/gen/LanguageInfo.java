...
public class LanguageInfo {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(name).append(version).append(mimetype).append(fileExtension).append(pygmentsLexer).append(nbconvertExporter).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(name, rhs.name).append(version, rhs.version).append(mimetype, rhs.mimetype).append(fileExtension, rhs.fileExtension).append(pygmentsLexer, rhs.pygmentsLexer).append(nbconvertExporter, rhs.nbconvertExporter).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
