...
public class Config {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(ip).append(transport).append(key).append(signatureScheme).append(controlPort).append(hbPort).append(shellPort).append(iopubPort).append(stdinPort).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(ip, rhs.ip).append(transport, rhs.transport).append(key, rhs.key).append(signatureScheme, rhs.signatureScheme).append(controlPort, rhs.controlPort).append(hbPort, rhs.hbPort).append(shellPort, rhs.shellPort).append(iopubPort, rhs.iopubPort).append(stdinPort, rhs.stdinPort).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
