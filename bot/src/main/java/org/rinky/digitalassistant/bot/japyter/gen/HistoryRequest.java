    ...
    extends Request
{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(output).append(raw).append(histAccessType).append(session).append(start).append(stop).append(n).append(pattern).append(unique).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(output, rhs.output).append(raw, rhs.raw).append(histAccessType, rhs.histAccessType).append(session, rhs.session).append(start, rhs.start).append(stop, rhs.stop).append(n, rhs.n).append(pattern, rhs.pattern).append(unique, rhs.unique).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
