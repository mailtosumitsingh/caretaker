    ...
    extends Reply
{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(history).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(history, rhs.history).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
