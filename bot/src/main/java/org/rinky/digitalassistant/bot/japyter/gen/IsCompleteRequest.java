    ...
    extends Request
{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(code).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(code, rhs.code).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
