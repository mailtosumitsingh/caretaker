    ...
    extends Reply
{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(protocolVersion).append(implementation).append(implementationVersion).append(languageInfo).append(banner).append(helpLinks).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(protocolVersion, rhs.protocolVersion).append(implementation, rhs.implementation).append(implementationVersion, rhs.implementationVersion).append(languageInfo, rhs.languageInfo).append(banner, rhs.banner).append(helpLinks, rhs.helpLinks).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
