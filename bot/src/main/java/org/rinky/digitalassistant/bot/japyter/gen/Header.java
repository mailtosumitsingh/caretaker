...
public class Header {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(msgId).append(username).append(session).append(msgType).append(version).append(date).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(msgId, rhs.msgId).append(username, rhs.username).append(session, rhs.session).append(msgType, rhs.msgType).append(version, rhs.version).append(date, rhs.date).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
