    ...
    extends Reply
{
    ...
    private List<Payload_> payload = new ArrayList<Payload_>();
    ...
    public ExecuteReply withPayload(List<Payload_> payload) {
        this.payload = payload;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(status).append(executionCount).append(payload).append(userExpressions).append(ename).append(evalue).append(traceback).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(status, rhs.status).append(executionCount, rhs.executionCount).append(payload, rhs.payload).append(userExpressions, rhs.userExpressions).append(ename, rhs.ename).append(evalue, rhs.evalue).append(traceback, rhs.traceback).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
