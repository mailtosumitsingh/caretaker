    ...
    extends Request
{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(code).append(silent).append(storeHistory).append(userExpressions).append(allowStdin).append(stopOnError).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(code, rhs.code).append(silent, rhs.silent).append(storeHistory, rhs.storeHistory).append(userExpressions, rhs.userExpressions).append(allowStdin, rhs.allowStdin).append(stopOnError, rhs.stopOnError).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
