    ...
    extends Broadcast
{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().appendSuper(super.hashCode()).append(code).append(executionCount).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(other)).append(code, rhs.code).append(executionCount, rhs.executionCount).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
